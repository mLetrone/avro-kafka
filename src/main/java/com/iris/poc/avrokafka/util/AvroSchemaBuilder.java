package com.iris.poc.avrokafka.util;
...
public class AvroSchemaBuilder {
    ...
    public Schema createAvroHttpRequestSchema(){
        ...
        Schema clientIdentifier = SchemaBuilder.record("ClientIdentifier").namespace("com.iris.poc.avrokafka.models.avro")
                .fields().requiredString("hostName").requiredString("ipAddress").endRecord();

        Schema avroHttpRequest = SchemaBuilder.record("AvroHttpRequest").namespace("com.iris.poc.avrokafka.models.avro").fields()
